...
{ _compile_id=1;
  ...
  result
    ...
    << "      if (*libpi::task::Task::ActiveTasks==0)\n"
    << "        for (size_t i=0; i<libpi::task::Task::TargetTasks; ++i)\n"
    << "          libpi::task::Task::Tasks.Send(shared_ptr<libpi::Value>());\n"
    << "      // Wait for task\n"
